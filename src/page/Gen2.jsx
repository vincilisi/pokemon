...
function Gen2() {
    ...
    useEffect(() => {
        async function fetchGen2Pokemon() {
            setLoading(true);
            const res = await fetch("http://localhost:4000/api/gen2");
    ...
    return (
        <div className="p-4">
            <h2 className="text-3xl font-bold text-yellow-600 mb-8 text-center">Pokédex Gen 2</h2>
